...
def create_patient(patient : Patient):
    ...
    # .model_dump =>> Convert model → Python dict
...
def update_patient(patient_id:str, patient_update: PatientUpdate):
    ...
    patient_pydandic_info = Patient(**existing_patient_info)

    #-> pydantic object -> dict
    existing_patient_info = patient_pydandic_info.model_dump(exclude='id')
